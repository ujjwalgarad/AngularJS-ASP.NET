<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="lab3.aspx.cs" Inherits="cmClassification.lab3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div ng-controller="EditorCtrl2" ng-cloak>
    <div class="container" >
    ...
    <div class="panel panel-info col-sm-8" style="padding-right:10px;">
     <%-- <div>--%>
        ...
        <!--------------------------------------------------------------------------------Matter List------------------------------------------------------------------------------------------------------------>
                ...
                <li ng-repeat="matter in filteredMatters = (client.matters | filter: searchMatter)| startFrom:(currentPage - 1) * defaultLimited | limitTo : defaultLimited"  <%--limitTo : defaultLimited--%>
                        ...
                        <!--Technology badges-->
                            <div style="padding-right:6px" class="col-md-6">
                                <ul dnd-list="matter.badges.technology.list"
                                    ...
                                    class="alert alert-info"
                                    style="max-height:130px;overflow-y:auto"> <!--send matter number as a 'typeOfTarget'-->
            ...
            <!--Pagination bar-->
            <ul uib-pagination total-items="filteredMatters.length" ng-model="currentPage" items-per-page="defaultLimited" max-size="15"></ul>
