            ...
            <div class="panel-body alert-success tree">
                 <ul>
                    <li><span><i class="icon-exclamation-sign"></i><i class="fa fa-home" aria-hidden="true"></i></span><strong>&nbsp;Client Types</strong>&nbsp;
                        <i class="fa fa-plus" aria-hidden="true" ng-click="addClient2Pool()"></i>
                        <ul>
                            <li ng-if="showAddClient">
                            ...
                            <li ng-repeat="b in clientType"
                                ...
                                style="display: block;">
                                    <span id="{{b.ItemId}}">
                                     ...
                                     <i class="fa fa-plus" aria-hidden="true" ng-click="addClientType(b.ItemId)"></i>
                                    <ul>
                                        <li ng-if="editingId==b.ItemId">
                                            <input type="text" ng-model="newClientLvl1_{{b.ItemId}}" />&nbsp;<button type="button" ng-click="saveNewClientLvl1(newClientLvl1_{{b.ItemId}})"><i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                                        </li>
